...
public interface VilleRepository extends JpaRepository<Ville,Integer> {
    ...
    @Query("SELECT v FROM Ville v WHERE v.departement.codeDepartement = :codeDptm AND v.population >= :min ORDER BY v.population DESC")
    ...
    @Query("SELECT v FROM Ville v WHERE v.departement.codeDepartement = :codeDptm AND v.population BETWEEN :min AND :max ORDER BY v.population DESC")
    ...
    @Query("SELECT v FROM Ville v WHERE v.departement.codeDepartement = :codeDptm ORDER BY v.population DESC LIMIT :top")
